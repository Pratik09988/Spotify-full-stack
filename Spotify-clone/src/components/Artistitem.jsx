...
const Artistitem = ({ name, image, desc, id }) => {
    ...
    return (
        <div onClick={() => navigate(`/artist/${id}`)} className="cursor-pointer w-[calc(50vw-24px)] min-w-[calc(50vw-24px)] sm:min-w-[180px] sm:w-auto p-2 px-3 rounded hover:bg-[#ffffff26]">
