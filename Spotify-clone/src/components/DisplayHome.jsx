...
const DisplayHome = () => {
    ...
    return (
        <>
            ...
            <div className="flex gap-2 items-center mt-4 overflow-x-auto max-w-full whitespace-nowrap scrollbar-hide">
            ...
            {(activeFilter === "all" || activeFilter === "albums") && (
                <div className="mb-4 min-w-0 max-w-full overflow-hidden">
                    ...
                    <div className="flex overflow-x-auto overflow-y-hidden max-w-full pb-2">
                        {albumsData.map((item) => (
