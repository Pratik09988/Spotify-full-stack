...
const DisplayHome = () => {
    ...
    return (
        <div className="w-full min-w-0 max-w-full overflow-hidden">
            ...
            <div className="flex gap-2 items-center mt-4 px-2 sm:px-0 overflow-x-auto max-w-full whitespace-nowrap scrollbar-hide">
            ...
            {(activeFilter === "all" || activeFilter === "albums") && (
                <div className="mb-4 w-full min-w-0 max-w-full overflow-hidden">
                    <h1 className="my-5 px-2 sm:px-0 font-bold text-2xl">
                        Featured Charts
                    </h1>
                    <div className="flex overflow-x-auto overflow-y-hidden w-full max-w-full pb-2">
                        {albumsData.map((item) => (
